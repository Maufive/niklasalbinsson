...
const Post: React.FC<{ post: PostType }> = ({ post }) => (
  <Link href={`/blog/${post.slug}`} passHref>
    <li className="w-full transform cursor-pointer rounded-xl bg-transparent from-transparent to-transparent p-1 transition-all hover:scale-[1.03] hover:bg-gradient-to-r hover:from-[#D8B4FE] hover:to-[#818CF8]">

...
export const NavItemIcon: React.FC<NavItemProps> = ({
  ...
  <Link passHref href={href}>
    <a
      ...
      } overflow-hidden rounded-xl px-3 py-3 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-opacity-75  md:rounded-lg md:px-6 md:py-2`}
    >
      {children}
    </a>
  </Link>

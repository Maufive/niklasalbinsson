...
const FooterNavigation = () => {
  ...
  return (
    <footer className="mx-auto my-0 mt-10 w-full max-w-2xl space-y-20 p-6 lg:px-0 pb-20 2xl:mt-32">
      <NowPlaying />
          ...
          {EXTERNAL_LINKS.map((link) => (
            <li key={link.href}>
              <a
                ...
                className="flex rounded-md p-1 text-foreground focus:ring focus:ring-primary"
              >
                {link.icon}
              </a>
            </li>

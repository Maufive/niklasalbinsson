...
summary: 'I spent the weekend rebuilding the carousel component seen on Twitch but using my favourite tools - React w/ Typescript, TailwindCSS and Framer Motion'
---
...
<i>
  Note: This component is built specifically for desktop, although I made it
  responsive it may not be the best fit for a mobile interface
</i>

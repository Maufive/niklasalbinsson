...
import DockProvider, { useDockContext, DockConfig } from "./context";
...
function Dock({
  ...
  return (
    <footer
      className={cn(
        "fixed bottom-[-14px] z-10 flex w-auto justify-center left-1/2 h-16 px-3 rounded-lg border border-border shadow-lg translate-y-[-50%] translate-x-[-50%]",
        className,
      )}
    >
